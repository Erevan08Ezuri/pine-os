...
class CameraBackend { public:virtual~CameraBackend()=default;virtual bool available()const=0;virtual bool start()=0;virtual void stop()=0;virtual bool capturePhoto(const std::filesystem::path&)=0;virtual void setAvailable(bool)=0;};
...
class NetworkBackend { public:virtual~NetworkBackend()=default;virtual bool wifiEnabled()const=0;virtual void setWifiEnabled(bool)=0;virtual bool connected()const=0;virtual std::string networkName()const=0;};
